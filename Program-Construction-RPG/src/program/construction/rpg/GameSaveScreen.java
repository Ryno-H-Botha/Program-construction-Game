...
public class GameSaveScreen extends JFrame {
    ...
    public GameSaveScreen(ProgramConstructionRPG gameInstance) {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new GameSaveScreen(new ProgramConstructionRPG()));
    }
}
