...
public class DoOrDontSaveScreen extends JFrame {
    ...
    public DoOrDontSaveScreen(ProgramConstructionRPG gameInstance ,Movement Game ) {
        ...
        slot1Button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                SwingUtilities.invokeLater(() -> {
                    GameSaveScreen saveScreen = new GameSaveScreen(DoOrDontSaveScreen.this.gameInstance, DoOrDontSaveScreen.this.Game);
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new DoOrDontSaveScreen(new ProgramConstructionRPG(),new Movement()));
    }
}
